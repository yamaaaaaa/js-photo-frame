...
function () {
  ...
  _createClass(Main, [{
    ...
    value: function syncCamera() {
      ...
      navigator.mediaDevices.getUserMedia(this.videoOptions).then(function (stream) {
    ...
    value: function drawFrame() {
      ...
      this.frameImage.onload = function () {
        _this2.frameContext.clearRect(0, 0, _this2.frame.width, _this2.frame.height);

        _this2.frameContext.drawImage(_this2.frameImage, 0, 0, _this2.frame.width, _this2.frame.height);
      };
